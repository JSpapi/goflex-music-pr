...
export function LikeBtn({ ...otherDatas }: IProps) {
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 189.2 87.507">
        <g id="hearts" transform="translate(-787.902 -454.998)">
          ...
          <g className={s.center_hearts}>
            <path
              className={s.center_hearts_inner}
              data-name="Path 16"
            ...
            />
            <path
              className={s.center_hearts_outer}
              data-name="Path 17"

...
// TODO 1 SCHEMA FOR OTP CODE VALIDATION
//   const registerSchema = object({
//     OTPCode: string()
//       .trim()
...
//   type OTPCodeField = TypeOf<typeof registerSchema>;

// TODO 2 USEFORM COMBINING WITH ZOD
//   const methods = useForm<OTPCodeField>({
//     resolver: zodResolver(registerSchema),
//   });

//   const { handleSubmit, reset } = methods;

//   const onConfirmOTP: SubmitHandler<OTPCodeField> = async (otpCode) => {
//     console.log(otpCode);
//   };
...
//             <form
//               className={s.authorization_form}
//               onSubmit={handleSubmit(onConfirmOTP)}
//             >
//               <InputField
//                 name="OTPCode"
//                 label="OTP code"
